...
const UNCOMMON_ITEMS = [
    ...
    'ccww:necromium_greatsword',
    'ccww:necromium_halberd',
    'ccww:necromium_hammer',
    'ccww:necromium_katana',
    'ccww:necromium_rapier',
    'ccww:necromium_scythe',
    'ccww:necromium_warglaive',
    'ccww:necromium_mace',
    'ccww:necromium_spear',
