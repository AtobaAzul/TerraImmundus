ServerEvents.recipes((e) => {
    ...
    e.shapeless('2x scguns:basic_poultice', ['farmersdelight:canvas', '#forge:string'])

    e.shapeless('2x scguns:honey_sulfur_poultice', [
        'paper',
        '#forge:dusts/sulfur',
    ...
    ]).replaceIngredient('farmersrespite:rose_hip_tea', 'minecraft:glass_bottle')

    e.shapeless('4x kubejs:soothing_dressing', [
        '4x scguns:basic_poultice',
        'farmersrespite:strong_rose_hip_tea',
    ]).replaceIngredient('farmersrespite:strong_rose_hip_tea', 'minecraft:glass_bottle')

    e.shapeless('4x kubejs:soothing_dressing', [
        '4x scguns:basic_poultice',
        'farmersrespite:long_rose_hip_tea',
    ]).replaceIngredient('farmersrespite:long_rose_hip_tea', 'minecraft:glass_bottle')
});
